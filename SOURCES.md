...
| Berlin | Landeswahlleiter Berlin / Amt für Statistik Berlin-Brandenburg | Official Berlin Open Data ZIP, copied manually to `raw/landtag/berlin/RBS_OD_Wahlkreise_AH2026.zip`; the tracked CSV only supplies `wk_nr -> wk_name` labels derived from the official Wahlkreiskarten PDFs at `https://www.statistik-berlin-brandenburg.de/wahlkreiskarten-2026/` because no better machine-readable official name table was found | ZIP shapefile + tracked CSV name lookup | 78 | CC-BY / dl-de/zero-2-0 |
